...
打开该链接如果没有下载，而是打开一个页面，那么将该页面保存为 redis-trib.rb，建议保存到 D:\redis 目录下。

集群的命令为：

```
D:\redis>ruby redis-trib.rb create --replicas 1 127.0.0.1:6300 127.0.0.1:6301 127.0.0.1:6302 127.0.0.1:6303 127.0.0.1:6304 127.0.0.1:6305
```
