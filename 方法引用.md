...
void test() {
     ...
     * 两个参数的构造函数
     */
    BiFunction<Integer, String, User> user1 = User::new;
}
```
...
void test() {
     ...
     * 四个参数的构造函数
     */
    UserFunction<Integer, String, Double, Date, User> user2 = User::new;
}
```
...
void test() {
     ...
     * 四个参数的构造函数
     */
    UserFunction<Integer, String, User> user2 = User::new;
}
```
