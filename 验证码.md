...
public class VerifyCodeController {
     ...
     */
    @GetMapping("/1/{type}")
    public BaseResponseVO<byte[]> captcha1(@PathVariable int type) {
        Captcha captcha = getCaptcha(type);
        if (captcha == null) {
            return BaseResponseVoUtil.success(new byte[0]);
        }
...
<html>
	...
	<script type="text/javascript">
		        var token = "eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsInVpZCI6IjIiLCJjcmVhdGVkIjoxNjg4MDE4MjY1MDcwLCJ1dHlwZSI6IjIiLCJpZCI6IjMxODM1NDhiYTVjZDQ2ZjY5N2NlMmMyYzVkNmRhOGM2IiwiZXhwIjoxNjg4MDI1NDY1LCJ0aWQiOiJiOGU4M2E1MTlhNDE0MTg1ODNiZDg0N2U4YjEwOGYyMiJ9.FjRJu1XA73nEhsmp5SBZtdC3sEM8n429mZCAE5EnNZKbjyyw3FbVNNkqHc_5L_mPd8go5IXovgIcKYhMcSU1ug";
		        $("#code1").click(function() {
		            var type =$("#type").val();
		            $.ajax({
		                url: "http://20.0.0.48/api/admin/code/1/"+type,
		                type: "get",
		                dataType: "json",
		        ...
		        $("#code2").click(function() {
		            var type =$("#type").val();
		            $.ajax({
		                url: "http://20.0.0.48/api/admin/code/2/"+type,
		                type: "get",
		                beforeSend: function(XMLHttpRequest) {
		                    XMLHttpRequest.setRequestHeader("access-token", token);
		                },
